...
class CheckoutResponseModel {
  /**
   * Create a CheckoutResponseModel.
  ...
  /**
   * Defines the metadata of CheckoutResponseModel
   *
   * @returns {object} metadata of CheckoutResponseModel
   *
   */
  mapper() {
    return {
...
module.exports = CheckoutResponseModel;
