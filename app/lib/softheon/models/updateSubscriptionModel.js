...
class UpdateSubscriptionModel {
  /**
   * Create a UpdateSubscriptionModel.
  ...
  /**
   * Defines the metadata of UpdateSubscriptionModel
   *
   * @returns {object} metadata of UpdateSubscriptionModel
   *
   */
  mapper() {
    return {
...
module.exports = UpdateSubscriptionModel;
